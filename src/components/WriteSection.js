...
import { 
  ...
  ChevronRight, Menu, X, Settings, Search, Bell, PencilLine, Home,
  Calendar, Layers, UploadCloud, Store, User, Info, Target, Clock,
  RotateCcw, Download, Sparkles, CheckCircle, AlertCircle, Lightbulb,
  Zap, Brain, MessageSquare, RefreshCw, Wand2
} from "lucide-react";
...
const initialChapters = [
  {
    ...
    content: "Jacque's fingers trembled as they touched the guitar strings for the first time on stage. The lights were blinding, the crowd expectant, and everything they'd worked for came down to this moment. Music had always been their escape, but tonight it would become their destiny.\n\nThe sound check earlier had gone well, but now, standing before hundreds of faces, doubt crept in like a familiar song in a minor key.",
    wordCount: 1205,
  ...
  },
  {
    ...
    content: "The dressing room smelled of stale coffee and nervous energy. Marcus paced back and forth, his bass guitar slung over his shoulder like a weapon he wasn't sure how to use. Sarah sat quietly in the corner, her drumsticks creating a rhythmic pattern against her knee.\n\n'We've got this,' Jacque whispered, more to convince themselves than the others.",
    wordCount: 892,
    ...
    grammarIssues: [
      { type: "suggestion", text: "Consider a comma after 'themselves'" }
    ]
  }
];
...
const Sidebar = ({ isOpen, onClose, authorName }) => {
  const menuItems = [
    ...
    { icon: PencilLine, label: "Write", active: true },
...
// --------- Story Details Panel (Simplified) ---------
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4 text-sm">
          <div>
            ...
            <span className="text-white font-medium">{story.currentWords.toLocaleString()} / {story.targetWords.toLocaleString()}</span>
          </div>
        ...
        {openMenu === 'characters' && (
          <div className="absolute top-full left-0 right-0 mt-2 p-3 bg-slate-900/95 backdrop-blur-xl rounded-lg border border-white/10 shadow-xl z-10">
            <div className="space-y-2">
              ...
              <button className="w-full p-2 border border-dashed border-slate-600 rounded-lg hover:border-slate-500 transition-colors">
...
const ChapterList = ({ chapters, selectedChapter, onSelectChapter, onAddChapter, onDeleteChapter, story }) => {
  return (
    <div className="w-80 h-full border-r border-white/10 bg-slate-900/50 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-2">
        {chapters.map((chapter) => (
          <div
            ...
            className={`
              p-4 rounded-xl mb-2 cursor-pointer transition-all duration-200 group
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <span className={`
                    ...
                    ${chapter.status === 'published' ? 'bg-green-500/20 text-green-300' : 'bg-yellow-500/20 text-yellow-300'}
                  `}>
                    {chapter.status}
                  </span>
      ...
      {/* Story Details Floating Menus - Below Chapters */}
    ...
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <button className="inline-flex items-center gap-2 px-6 py-3 bg-indigo-500 hover:bg-indigo-400 text-white rounded-xl font-medium transition-colors">
            <Plus size={18} />
            Create New Chapter
          </button>
        </div>
...
export default function WriteSection() {
  ...
  const handleApplySuggestion = (suggestion) => {
    ...
    // Here you would implement the logic to apply AI suggestions
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      ...
      <div className="flex">
        ...
        <div className="flex-1 lg:ml-0 h-[calc(100vh-4rem)] flex flex-col">
          ...
          {/* Story Details Section - Now just a clean header */}
          <StoryDetailsPanel story={currentStory} />

          {/* AI Assistant Panel - Now horizontal across the top */}
          <AIAssistantPanel 
