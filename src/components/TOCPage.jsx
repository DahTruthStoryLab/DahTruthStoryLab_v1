...
import {
  ...
  Trash2, Copy, Download, Save, RotateCcw, AlertCircle
} from "lucide-react";
...
const STORAGE_KEY = "dahtruth-story-lab-toc";
    ...
    chapters: [
      {
        id: 1,
        title: "Chapter 1",
        content: "Jacque steps on stage for the first time. The crowd hums; nerves prickle at the skin. One clear note steadies the soul.",
        synopsis: "",
      ...
      },
      {
        id: 2,
        title: "Chapter 2", 
        content: "Backstage, friendships strain. A whispered truth forces Jacque to reconsider who really has their back.",
        synopsis: "",
        updatedAt: Date.now() - 1000 * 60 * 60 * 24 * 2,
      },
      {
...
export default function TOCPage() {
  ...
  const generateAll = async () => {
    ...
    // Generate in parallel (limited concurrency)
    const batchSize = 3;
  ...
  const updateChapter = (id, updates) => {
    setChapters(c => 
      c.map(ch => ch.id === id ? { ...ch, ...updates, updatedAt: Date.now() } : ch)
    );
  };
          ...
          <div className="flex items-center justify-between px-6 py-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="hidden sm:inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-blue-600/30 border border-blue-400/30 hover:bg-blue-600/40 text-blue-100 text-sm"
          ...
          <div className="px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-slate-400 mt-1">{progress.toFixed(1)}% complete</div>
              </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {isOpen && (
                        <div className="mt-3 text-sm text-slate-300">
                          {/* Editable title */}
                          <div className="mb-3">
                            <div className="text-xs text-slate-400 mb-1">Chapter title</div>
                            <input
                              value={ch.title}
          ...
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <div className="bg-blue-950/90 backdrop-blur-xl rounded-3xl p-6 max-w-md w-full border border-blue-800/40 shadow-2xl">
              ...
              <div className="text-slate-300 mb-6">
                Are you sure you want to delete "{chapters.find(ch => ch.id === showConfirm)?.title}"? 
