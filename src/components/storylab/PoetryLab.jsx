      ...
      <div className="sticky top-0 z-10 border-b border-slate-200 bg-white">
        <div className="px-6 py-4 flex items-center justify-between gap-4">
          <div className="min-w-0">
            <h1 className="text-lg font-semibold text-slate-900 truncate">Poetry</h1>
          ...
          <aside className="col-span-12 lg:col-span-3">
            <div className="rounded-2xl border border-slate-200 bg-white overflow-hidden">
                      ...
                      >
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <button
                            ...
                            onClick={(e) => { e.stopPropagation(); deletePoem(p.id); }}
                            title="Delete poem"
                          >
              ...
              <div className="border-t border-slate-200">
                <div className="px-4 py-3 border-b border-slate-200">
                  <div className="text-sm font-semibold text-slate-900">Poetry Studio</div>
                  ...
                  <div className="flex items-center justify-between gap-3 mb-4">
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-2 text-xs text-slate-500 flex items-center gap-4">
                        <span>Words: <span className="font-semibold text-slate-700">{stats.words}</span></span>
                        <span>Lines: <span className="font-semibold text-slate-700">{stats.lines}</span></span>
                      </div>
                    </div>
