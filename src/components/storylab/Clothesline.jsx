  ...
  <div className="mx-auto mb-8">
    <div className="relative mx-auto max-w-3xl rounded-2xl border border-white/40 bg-white/20 backdrop-blur-xl px-6 py-6 text-center shadow overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <p className="mt-1 text-sm text-ink/70 max-w-xl mx-auto">Characters as pegged cards along a line — relationships at a glance.</p>
      </div>
    </div>
  </div>
);
  ...
  return (
    <div className="rounded-xl border border-white/60 bg-white/80 p-3 shadow-sm min-w-[220px]">
      <div className="flex items-center gap-2">
        ...
        <span className="ml-auto text-[10px] rounded-full px-2 py-0.5 border bg-white">{c.role || "Role"}</span>
      </div>
      {c.rel && <div className="text-xs text-ink/70 mt-1">{c.rel}</div>}
