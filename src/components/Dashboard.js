      ...
      `}>
        ...
        <div className="p-4 border-t border-white/60 flex-shrink-0">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="text-ink hover:opacity-80 p-1 rounded-lg hover:bg-white/70 transition-all duration-200">
              <Plus size={16} />
            </button>
          </div>
          ...
          <div className="space-y-2 max-h-32 overflow-y-auto">
            {userNovels.length === 0 ? (
              ...
              userNovels.map((novel) => (
                <div key={novel.id} className="p-3 rounded-lg glass-soft border border-white/30 transition-all duration-200 cursor-pointer">
                  <h4 className="text-sm font-medium text-ink truncate">{novel.title}</h4>
                  <p className="text-xs text-muted">{novel.words} words</p>
                </div>
              ))
            )}
          </div>
        ...
        <div className="p-4 border-t border-white/60 flex-shrink-0">
          <div className="p-4 glass-soft rounded-xl border border-white/30">
            <div className="flex items-center gap-3 mb-3">
              ...
              <button className="text-muted hover:text-ink p-1 rounded-lg hover:bg-white/70 transition-all duration-200">
                <Settings size={16} />
              </button>
            </div>
            <div className="space-y-2">
              <button className="w-full text-left px-3 py-2 text-xs text-muted hover:text-ink hover:bg-white/70 rounded-lg transition-all duration-200">
                Account Settings
              </button>
              <button 
                onClick={() => navigate('/')}
