      ...
      `}>
        ...
        <div className="p-4 border-t border-orange-500/20 flex-shrink-0">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="text-orange-400 hover:text-orange-300 p-1 rounded-lg hover:bg-orange-500/20 transition-all duration-200">
              <Plus size={16} />
            </button>
          </div>
          ...
          <div className="space-y-2 max-h-32 overflow-y-auto">
            {userNovels.length === 0 ? (
              ...
              userNovels.map((novel) => (
                <div key={novel.id} className="p-3 rounded-lg bg-slate-800/30 border border-white/5 hover:bg-slate-800/50 hover:border-orange-500/20 transition-all duration-200 cursor-pointer group">
                  <h4 className="text-sm font-medium text-white truncate group-hover:text-orange-300 transition-colors">{novel.title}</h4>
        ...
        <div className="p-4 border-t border-orange-500/20 flex-shrink-0">
          <div className="p-4 bg-slate-800/30 rounded-xl border border-orange-500/10 hover:bg-slate-800/50 transition-all duration-200">
            <div className="flex items-center gap-3 mb-3">
              ...
              <button className="text-slate-400 hover:text-orange-400 p-1 rounded-lg hover:bg-orange-500/10 transition-all duration-200">
                <Settings size={16} />
              </button>
            </div>
            <div className="space-y-2">
              <button className="w-full text-left px-3 py-2 text-xs text-slate-400 hover:text-orange-400 hover:bg-orange-500/10 rounded-lg transition-all duration-200">
                Account Settings
              </button>
              <button 
                onClick={() => navigate('/')}
