  ...
  return (
    <div className="min-h-screen bg-[rgb(244,247,250)] text-slate-900 flex flex-col">
      ...
      {view === "editor" && (
        ...
        {/* Main layout */}
<div
  className="relative isolate grid gap-6 flex-1 min-h-0 min-w-0 overflow-hidden"
  style={{
...
>
  {/* Left Sidebar */}
  <aside className="space-y-3 overflow-y-auto min-w-0 min-h-0 relative z-20">
    {showSearch && (
      <SearchPanel
        chapters={chapters}
        onSelectChapter={(id) => {
  ...
  <div className="min-h-0 min-w-0 overflow-hidden relative z-10">
    {/* IMPORTANT: kill horizontal overflow at this level */}
    <div className="min-h-0 min-w-0 w-full h-full overflow-y-auto overflow-x-hidden">
  ...
  {showAssistant && (
    <section className="flex flex-col bg-white border border-slate-200 rounded-xl shadow-sm min-h-0 max-h-full overflow-hidden relative z-20">
      {/* keep your assistant JSX exactly as you already have it */}
