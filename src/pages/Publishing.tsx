  ...
  >
          ...
          {isWide && (
            <aside>
              ...
              <div style={{ display: "grid", gap: 6 }}>
                {chapters.map((c) => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 10,
                      border: `1px solid ${
                        c.id === activeChapterId ? theme.accent : theme.border
                      }`,
                      background:
                        c.id === activeChapterId ? theme.highlight : theme.white,
                      color: theme.text,
                      cursor: "pointer",
                      fontSize: 12,
                    }}
                ...
                <button
                  onClick={addChapter}
                  style={{ ...styles.btnPrimary, marginTop: 6, fontSize: 12 }}
                >
                  + Add Chapter
                </button>
              </div>
          ...
          <section>
            ...
            >
              ...
              <div style={{ marginLeft: "auto", display: "flex", gap: 4 }}>
                ...
                <button
                  style={{ ...styles.btnPrimary, padding: "3px 10px", fontSize: 10, height: 24 }}
    ...
    <section>
      ...
      >
        ...
        <div
          style={{ width: 1, height: 16, background: theme.border, margin: "0 2px" }}
        />
