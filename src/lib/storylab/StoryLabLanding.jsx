...
---------------------------- */
function SidebarSection({ title, icon: Icon, iconColor, tools, defaultOpen = false }) {
  ...
  return (
    <div className="md:hidden sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200 px-4 py-3">
      <div className="flex items-center justify-between">
        ...
        <button onClick={onMenuClick} className="p-2 rounded-xl hover:bg-slate-100" aria-label="Open menu">
          <Menu size={22} />
        </button>
      </div>
    </div>
    ...
    <div className="min-h-screen" style={{ background: `linear-gradient(180deg, ${BRAND.cream} 0%, #f1f5f9 100%)` }}>
      ...
      <main className="md:ml-56">
        <div className="max-w-4xl mx-auto px-4 md:px-6 py-8">
          ...
          <div className="rounded-3xl p-10 mb-10 text-center relative overflow-hidden"
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center gap-3 mb-6">
                <div className="w-11 h-11 rounded-2xl flex items-center justify-center" style={{ background: `${BRAND.navy}60` }}>
                ...
                <div className="w-11 h-11 rounded-2xl flex items-center justify-center" style={{ background: `${BRAND.purpleLight}60` }}>
              ...
              {story.title && (
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/15 border border-white/20">
                  ...
                  {story.wordCount > 0 && (
                    <span className="text-amber-300 text-sm">• {story.wordCount.toLocaleString()} words</span>
                  )}
                </div>
              )}
            </div>
          ...
          {/* Shared Tools */}
          <div className="mb-8">
            <h2 className="text-lg font-bold mb-4" style={{ color: BRAND.navy, fontFamily: "'EB Garamond', Georgia, serif" }}>
              Shared Tools
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <button key={tool.label} onClick={() => navigate(tool.path)}
                  ...
                  style={{ background: "white", border: `1px solid ${tool.color}20` }}>
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-sm" style={{ color: BRAND.navy, fontFamily: "'EB Garamond', Georgia, serif" }}>{tool.label}</h3>
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            <button onClick={() => navigate("/compose")}
              ...
              style={{ background: `${BRAND.navy}10`, border: `1px solid ${BRAND.navy}20`, color: BRAND.navy }}>
              <PenLine size={16} /> Writer
            </button>
            <button onClick={() => navigate("/dashboard")}
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-medium transition-all hover:scale-105"
              style={{ background: `${BRAND.gold}15`, border: `1px solid ${BRAND.gold}25`, color: BRAND.goldDark }}>
