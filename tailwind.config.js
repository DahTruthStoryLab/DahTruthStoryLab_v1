  ...
  theme: {
    extend: {
      colors: {
        ...
        muted:  "#475569",   // secondary text (higher contrast)
        primary:"#4F46E5",   // accessible CTA (indigo-600)
        accent: "#CAB1D6",   // mauve
        gold:   "#D4AF37",   // gold accent
        border: "#E5EDF7",   // light borders for glass UI

        // Brand aliases used by the component (so classes like bg-brand-*) resolve
        "brand-navy": "#0B1B3B", // deep navy (used for rings, headers, nodes)
        "brand-rose": "#CAB1D6", // map to your mauve/accent for now
        "brand-gold": "#D4AF37", // gold accent
        "brand-mauve": "#8B6F8F", // optional darker mauve (adjust to taste)
        "brand-ink" : "#0F172A", // text ink
      },
      fontFamily: {
